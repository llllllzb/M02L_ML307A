...
#define APP_PARAM_FLAG          0x2C
#define BOOT_PARAM_FLAG         0xB0
#define OTA_PARAM_FLAG          0x30

#define EEPROM_VERSION									"M02L_ML307A_V1.0.0"
...
typedef struct
{
    ...
    uint16_t gpsuploadgap;	//该参数在m02不带gps的设备上是以分钟为单位的
